...
function UserProfile() {
  ...
  const handleUpdates = async(e) => {
    ...
    try {
      const response = await axios.put(`https://skill-exchange-server.onrender.com/users/update/${userId}`, updates);
  ...
  const handleLogout = async (e) => {
    ...
    try {
      ...
      showToastMessage2("Network error");
    }
  };
  ...
  const fetchUserProfile = async () => {
    try {
      setLoading(true);
      const response = await axios.get(`https://skill-exchange-server.onrender.com/users/getUserProfile/${userId}`);
...
<>
  ...
  <div className="w-[95%] mx-2 md:w-1/2 lg:w-1/4 md:h-[90vh] lg:h-[100vh] md:mx-4 bg-white flex flex-col my-5 rounded-lg shadow-lg md:sticky md:top-14 lg:top-2">
    {/* Profile Section */}
  ...
  {/* rightcontainer */}
    <div className=' w-full lg:w-3/4 mx-auto my-5 p-6 bg-lime-100 rounded-lg shadow-lg md:p-8'>
    {<div className="w-full lg:w-2/3 h-auto mx-auto my-5 p-6 bg-white  rounded-lg ">
        ...
        <p className='text-2xl font-semibold text-center'>Go through fire and be ready for the strong comeback</p>


      </div>}
     
  <div className="max-w-4xl mx-auto my-5 p-6 bg-white rounded-lg shadow-lg md:p-8" id='userAbout'>
    <header className="text-center mb-6">
      <h1 className="text-3xl font-bold text-blue-600 md:text-4xl">About</h1>
    </header>
...
<div className="flex justify-end mt-6">
  {isEditing && visibleDiv === 0 ? (
    ...
    <section className="border-t border-gray-200 pt-6">
      ...
      <p className="text-gray-700 text-lg">
        <span className="font-medium">Phone:</span> {data.phone || "Not available"}
      </p>
    </section>
  </div>
      

  <div className=" max-w-4xl  mx-auto my-5 p-6 bg-white rounded-lg shadow-lg md:p-8" id='userSkills'>
    <header className="text-center mb-6">
      <h1 className="text-3xl font-bold text-blue-600 md:text-4xl">Skills Section</h1>
    </header>
      ...
      {isEditing && visibleDiv===1 && (
        <div className="mt-4">
          ...
          <p className="text-sm text-gray-400 mt-2">
            Add skills separated by commas. Example: React.js, Node.js, Tailwind CSS
          </p>
        </div>
      )}
    </section>
  ...
  {isEditing && visibleDiv === 1 ? (
    ...
    >
      ...
      <div className="max-w-4xl mx-auto my-5 p-6 bg-white  rounded-lg shadow-lg" id='userCourse'>
        <header className="text-center mb-6">
      ...
      {data.Course && data.Course.length > 0 ? (
        ...
        <p className="text-lg text-gray-500 text-center">
          wan't to provide any course. Click "Add" to include your course.
        </p>
      )}
      ...
      {isEditing && visibleDiv===2 && (
        <div className="mt-4">
          ...
          />
          <p className="text-sm text-gray-400 mt-2">
            Add course separated by commas. Example: cooking, mushroom farming,
          </p>
        </div>
      )}
    </section>
  ...
  {isEditing && visibleDiv === 2 ? (
    ...
    >
      ...
      <div className="max-w-4xl mx-auto my-5 p-6 bg-white shadow-lg rounded-lg" id="userContact">
  <header className="text-center mb-6">
  ...
  {/* About Section */}
  <section className="mb-6">
    <h2 className="text-lg  mb-2">hello, you can connect with me through following media</h2>
...
>
  Send an Email
    ...
    >
      ...
      <div className="max-w-4xl mx-auto my-5 p-6 bg-white shadow-lg rounded-lg " id='userLearnt'>
        <header className="text-center mb-6">
        <h1 className="text-3xl font-bold text-blue-500">what learned till now</h1>
        </header>
