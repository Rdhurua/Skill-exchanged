  ...
  return (
    ...
    <nav className="flex flex-col md:flex-row md:justify-between md:items-center max-w-7xl mx-auto">
     ...
     <div className="md:hidden">
      ...
      {/* Desktop Menu */}
      <ul className="hidden md:flex space-x-6 items-center mt-4 md:mt-0">
        <li><a href="#" className="hover:underline text-lg hover:text-blue-700 font-semibold">Home</a></li>
        <li><a href="#" className="hover:underline text-lg hover:text-blue-700 font-semibold">About</a></li>
        <li><a href="#" className="hover:underline text-lg hover:text-blue-700 font-semibold">Features</a></li>
        <li><a href="#" className="hover:underline text-lg hover:text-blue-700 font-semibold">Contact</a></li>
        <li className="ml-4"><Logindia value={false} /></li>
      </ul>
