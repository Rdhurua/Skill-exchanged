      ...
      <nav className="flex flex-col md:flex-row md:justify-between md:items-center max-w-7xl mx-auto">
        <div className="flex justify-between items-center w-full lg:w-auto ">
          <a href="/">
            <div className="flex items-center space-x-3">
              ...
              />
              <h1 className="text-2xl font-bold">Skill-Exchanger</h1>
            </div>
          </a>
          ...
          <div className="md:hidden">
            <button
              onClick={toggleMenu}
              className="focus:outline-none text-purple-600"
            >
              <svg
                className="w-6 h-6"
        ...
        <ul className="hidden md:flex md:space-x-4 md:mr-14 lg:space-x-6 items-center mt-4 md:mt-0">
          ...
          <li className="relative">
            ...
            {dropdownOpen && (
              <ul className="absolute left-0 mt-2 bg-gray-100 rounded-md shadow-lg py-5 px-2">
                <li>
                  <Link
                    to={"/AdminLogin"}
                    className="block px-4 py-1 text-lg font-semibold rounded-md hover:bg-purple-600 hover:text-white "
                  >
                    Admin
                  </Link>
                </li>
