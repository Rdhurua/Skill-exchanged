      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 px-4 lg:px-10">
        ...
        <div className="p-4 border rounded-lg shadow-md h-[27rem] md:h-80 w-full transition-all duration-300 ease-in-out transform hover:scale-105 hover:shadow-lg hover:bg-gray-600 hover:text-white">
          ...
          <div className="flex flex-col md:flex-row justify-around items-start h-[50vh] md:h-full">
            ...
            <p className='text-justify  text-md md:text-lg'>Share your knowledge and engage with learners in your area.Offer your skills to those seeking to learn and grow locally.Build connections by teaching and inspiring others nearby.</p>
          </div>
        </div>
        ...
        <div className="p-4 border rounded-lg shadow-md h-[27rem] md:h-80 w-full transition-all duration-300 ease-in-out transform hover:scale-105 hover:shadow-lg hover:bg-gray-600 hover:text-white">
          ...
          <div className="flex flex-col md:flex-row justify-around items-start h-[50vh] md:h-full">
            ...
            <p className='text-justify text-md md:text-lg'>Easily book or offer premium classes using our seamless payment system.Take advantage of our integrated platform for secure transactions.Access high-quality classes and services with hassle-free payments.</p>
          </div>
        </div>
        ...
        <div className="p-4 border rounded-lg shadow-md h-[27rem] md:h-80 w-full transition-all duration-300 ease-in-out transform hover:scale-105 hover:shadow-lg hover:bg-gray-600 hover:text-white">
          ...
          <div className="flex flex-col md:flex-row justify-around items-start h-[50vh] md:h-full">
            ...
            <p className='text-justify text-md md:text-lg'>Use our integrated payment system to book or offer premium classes.</p>
          </div>
        </div>
      </div>
    </div>
