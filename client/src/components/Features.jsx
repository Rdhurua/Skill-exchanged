  ...
  return (
    ...
    <div className="max-w-7xl mx-auto text-center  min-h-screen">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 px-4 lg:px-10">
        <div className="p-4 border rounded-lg shadow-md h-72 md:h-80 w-full transition-all duration-300 ease-in-out transform hover:scale-105 hover:shadow-lg hover:bg-blue-500 hover:text-white">
          <h4 className="text-xl md:text-2xl font-semibold mb-2">Find Skills</h4>
          <div className="flex flex-col md:flex-row justify-around items-start h-full">
            <img src="https://www.wikihow.com/images/thumb/9/9b/Learn-New-Things-Step-14.jpg/v4-460px-Learn-New-Things-Step-14.jpg.webp" alt="" className="h-32 w-full md:h-[77%] md:w-1/2 md:mr-6 mb-4 md:mb-0 object-cover rounded shadow-md" />
        ...
        <div className="p-4 border rounded-lg shadow-md h-72 md:h-80 w-full transition-all duration-300 ease-in-out transform hover:scale-105 hover:shadow-lg hover:bg-blue-500 hover:text-white">
          ...
          <div className="flex flex-col md:flex-row justify-around items-start h-full">
            <img src="https://assets.aten.com/webpage/shared/Product-Landing-Page/Control_System/RBS/050_Features_HoldEfficient_n2.png" alt="" className="h-32 w-full md:h-[77%] md:w-1/2 md:mr-6 mb-4 md:mb-0 object-cover rounded shadow-md" />
